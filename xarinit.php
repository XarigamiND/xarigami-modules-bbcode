...
function bbcode_upgrade($oldversion)
{
    switch ($oldversion) {
        ...
        case '2.0.1':
        case '2.0.2':
                xarModSetVar('bbcode','magiclink',true); //option - transform urls without specific bbcode url tags
        case '2.0.3':
            //upgrade of syntax highlighter to 3.0.83
